...
## Expanded blog experiment

The [expanded report](benchmark_results/qwen_blog_expanded/BLOG_DATA.md) adds 4,376 scored calls across 544 fresh cases, with matched JSON/TOON comparisons, normalized input/output ablations and a separate native JSON-schema check. It includes uncertainty, failure accounting and editable charts. Adapter code was frozen throughout this expanded run; no new tests were added. The hybrid did not consistently improve quality and cost together.
